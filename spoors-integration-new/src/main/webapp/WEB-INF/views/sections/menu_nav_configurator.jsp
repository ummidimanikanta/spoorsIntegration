  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar1">
      ...
      <ul class="nav navbar-nav">
        <li style="border: 0;"><a href="${pageContext.servletContext.contextPath}/web?isOpp=true" style="padding: 0;"><img alt="" src="${pageContext.servletContext.contextPath}/resources/img/effort.png" height="25px" width="100px" style="
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav" id="orderedUl">
						...
						<li id="ConfigurationTransaction">
							<a href="${pageContext.servletContext.contextPath}/integration/txnHit/1374?formId=2456727">
								Configuration Form Transaction
							</a>
						</li>
						<li id="ConfigurationTransaction">
							<a href="${pageContext.servletContext.contextPath}/integration/txnHit/1374?workId=1457409">
								Configuration Work Transaction
							</a>
						</li>
