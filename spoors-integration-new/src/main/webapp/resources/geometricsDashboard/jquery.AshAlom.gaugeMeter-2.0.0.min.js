    ...
    e.fn.gaugeMeter = function(t) {
        ...
        return this.each(function() {
            ...
            function n(a) {
                ...
                "1" == l.animate_gauge_colors && (l.fgcolor = d, "1" == l.animate_text_colors && e("SPAN", "#" + l.id).html("<s>" + l.prepend + "</s>" + (null !=l.display ? l.display.toString():Math.floor(M).toString()) + "<u>" + l.append + "</u>").css({
                    color: d
            ...
            var r, o = ["id", "percent", "used", "total", "size", "prepend", "append", "theme", "color", "back", "width", "style", "stripe", "animationstep", "animate_gauge_colors", "animate_text_colors", "label", "label_color", "display"],
                l = {},
                c = 0,
                p = e(this),
                s = !1;
