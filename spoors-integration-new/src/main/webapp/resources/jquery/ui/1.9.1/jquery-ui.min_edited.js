    ...
    e.widget("ui.droppable", {
        ...
        prepareOffsets: function(t, n) {
            var r = e.ui.ddmanager.droppables[t.options.scope] || [],
                i = n ? n.type : null,
                s = (t.currentItem || t.element).find(":data(droppable)").addBack();
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _mouseCapture: function(t, n) {
            ...
            if (this.options.handle && !n) {
                var o = !1;
                e(this.options.handle, i).find("*").addBack().each(function() {
                    this == t.target && (o = !0)
                });
                if (!o) return !1
            }
    ...
    function(e, t) {
        ...
        e.widget("ui.slider", e.ui.mouse, {
            ...
            _mouseCapture: function(t) {
                ...
                }), c.range === !0 && this.values(1) === c.min && (o += 1, s = e(this.handles[o])), u = this._start(t, o), u === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = o, s.addClass("ui-state-active").focus(), a = s.offset(), f = !e(t.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = f ? {
                    left: 0,
                    top: 0
                } : {
    ...
    function(e, t) {
        ...
        e.widget("ui.tabs", {
            ...
            load: function(t, n) {
                ...
                if (s(o[0])) return;
                this.xhr = e.ajax(this._ajaxSettings(o, n, a)), this.xhr && this.xhr.statusText !== "canceled" && (i.addClass("ui-tabs-loading"), u.attr("aria-busy", "true"), this.xhr.done(function(e) {
                    setTimeout(function() {
                ...
                this._super(), this._on({
                    tabsbeforeload: function(e, t) {
                        ...
                        var n = t.tab.find("span"),
                            r = n.html();
                        n.html(this.options.spinner), t.jqXHR.always(function() {
                            n.html(r)
                        })
                    }
                })
