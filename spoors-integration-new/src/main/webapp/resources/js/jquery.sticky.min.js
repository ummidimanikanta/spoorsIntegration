 ...
 function c(d, e) {
  ...
  e = b.extend({
   ...
   animations: {
    ...
    "mid-left": ["zoomInLeft", "zoomOutLeft"],
    "mid-mid": ["zoomIn", "zoomOut"],
    "mid-right": ["zoomInRight", "fadeOutRight"],
    "bottom-left": ["zoomInRight", "zoomOutRight"],
    "bottom-mid": ["zoomInDown", "zoomOutDown"],
    "bottom-right": ["zoomInRight", "fadeOutRight"]
   },
  ...
  if ((f = d.find(".sticky-holder.sticky-" + e.position)).length == 0) {
   f = b("<div />", {
    "class": "sticky-holder sticky-" + e.position
   }).css({
    width: e.width
   })
  }
  ...
  if (!f.is(":empty")) {
   ...
   if (r.title) {
    b("<div />", {
     "class": r.titleClassName
    }).html(r.title).appendTo(p)
   }
   if (r.icon) {
    r.body = '<img src="' + r.icon + '" class="' + r.iconClassName + '" />' + r.body
   }
   b("<p />", {
    "class": r.bodyClassName
   }).html(r.body).appendTo(p);
