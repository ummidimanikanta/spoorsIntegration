...
MC.ColorPicker = function() {
    ...
    d.prototype = {
        ...
        e: function(b, c, d) {
            var a = document.createElement("div");
            if (b == "TT") {
            	a.style.backgroundColor = "#FFFFF1";
                a.setAttribute("rgb", "#FFFFF1");
            } else {
        ...
        g: function() {
            for (var a = this, c, b = a.c, i = ["00", "00", "11", "22", "33", "44", "55", "66", "77", "88", "99", "AA", "BB", "CC", "DD", "EE", "TT", "FF"], h = 0; h < 18; h++) {
                c = a.e(i[h], i[h], i[h]);
                b.appendChild(c)
            }
            a.d(b);
        ...
        p: function(c) {
            ...
            b(c, "click", function(b) {
                if (a.r.parentNode == c && a.r.style.display == "block") a.r.style.display = "none";
                else {
                    if (a.i > -1) a.S[a.i].style.zIndex = 1;
                    a.i = c.i;
