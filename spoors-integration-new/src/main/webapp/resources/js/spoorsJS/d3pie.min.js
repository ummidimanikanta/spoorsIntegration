        ...
        j = {
            ...
            positionLabelGroups: function(a, b) {
                "none" !== a.options.labels[b].format && d3.selectAll("." + a.cssPrefix + "labelGroup-" + b).style("opacity", 0).attr("transform", function(c, d) {
                    var e, f, isExtend;
                    if ("outer" === b){
                    		if(a.outerLabelGroupData[d].x < 0 ){
                    			e=1;
                    			isExtend=true;
                    		}else if(a.outerLabelGroupData[d].x > 230){
                    			e=229.286056916196;
                    			isExtend=true;
                    		}else{
                    		...
                    		if(isExtend && a.outerLabelGroupData[d].y>133 && a.outerLabelGroupData[d].y<153){
                    			f = a.outerLabelGroupData[d].y-10;
                    		}else{
                    			f = a.outerLabelGroupData[d].y;
                    		}
                    		
                    	//e = a.outerLabelGroupData[d].x < 0 ? 1 : a.outerLabelGroupData[d].x > 230 ? 229.286056916196 : a.outerLabelGroupData[d].x , f = a.outerLabelGroupData[d].y;
                    }else {
